...
public class LmcBuilder implements ILmcBuilder {
    ...
    public Document build(){
        ...
        lmc.addContent(body);
        lmc.getChild("header",Lmc.lmc).setAttribute("total-files",""+docs.size());
        lmc.getChild("header",Lmc.lmc).setAttribute("started",""+new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss'Z'").format(new Date()));
        lmc.getChild("header",Lmc.lmc).setAttribute("last-mod",lmc.getChild("header",Lmc.lmc).getAttributeValue("started"));
