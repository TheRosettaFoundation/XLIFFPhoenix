...
public class TmxToXliff {
    ...
    public boolean isOmitSameLang() {
        return omitSameLanguageConvertion;
    }

    public void setOmitSameLanguageConvertion(boolean omitSameLanguageConvertion) {
        this.omitSameLanguageConvertion = omitSameLanguageConvertion;
    }
    public TmxToXliff(){
        doc=new Document();
    }
    ...
    public List<Document> convertAll(String sourceLang){
        ...
        for(String lang:langs){
            if(lang.equalsIgnoreCase(sourceLang)&&omitSameLanguageConvertion)continue;
            results.add(convert(sourceLang,lang));
        }
        return results;
    }
    ...
    public Document convert(String sourceLang, String targetLang){
        ...
        XliffFile file = new XliffFile(sourceLang,tmxHeader.getAttributeValue("datatype"),"TMX");
